import numpy as np
from utils.constants import GAS_USED_BY_SWAP, GAS_USED_BY_BORROW, GAS_USED_BY_REPAY, GAS_USED_BY_DEPOSITING_COLLATERAL, GAS_USED_BY_OPEN_BUY_AND_SELL_POSITION, GAS_USED_BY_CLOSE_BUY_AND_SELL_POSITION
